...
import org.aplusstudios.com.signalclient.BuildConfig;
import org.aplusstudios.com.signalclient.interfaces.DomainFrontingTrustStore;
...
public class SignalServiceNetworkAccess {
    ...
    private static final String COUNTRY_CODE_KENYA = "+254";
    ...
    public SignalServiceNetworkAccess(Context context) {
        ...
        this.censorshipConfiguration = new HashMap<String, SignalServiceConfiguration>() {{
            ...
            put(COUNTRY_CODE_KENYA, serviceConfig);
